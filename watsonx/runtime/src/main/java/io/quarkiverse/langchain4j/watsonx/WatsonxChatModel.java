...
public class WatsonxChatModel implements ChatLanguageModel {
    ...
    public WatsonxChatModel(Builder config) {
        ...
        if (config.logRequests || config.logResponses) {
            ...
            builder.clientLogger(new WatsonxRestApi.WatsonClientLogger(config.logRequests,
                    config.logResponses));
        }
    ...
    public Response<AiMessage> generate(List<ChatMessage> messages) {
        ...
        Parameters parameters = new Parameters(decodingMethod, minNewTokens, maxNewTokens);
    ...
    public static final class Builder {
        ...
        private Integer minNewTokens = 1;
